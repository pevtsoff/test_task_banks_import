...
expected_output = {
    './test_data/valid/bank1.csv': 'date,transaction_type,amount,from,to\n'
                             '2019-10-01,remove,99.20,198,182\n'
                             '2019-10-02,add,2000.10,188,198\n',
    './test_data/valid/bank2.csv': 'date,transaction_type,amount,from,to\n'
                             '2019-03-10,remove,99.40,198,182\n'
                             '2019-04-10,add,2123.50,188,198\n',
    './test_data/valid/bank3.csv': 'date,transaction_type,amount,from,to\n'
